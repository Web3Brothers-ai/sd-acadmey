        ...
        <div className="max-w-4xl mx-auto px-4 preserve-3d">
          <div className={`transform transition-all duration-1000 ${showTitle ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
            <h1 className="text-6xl md:text-7xl font-bold text-white mb-4">
              <span className="inline-block transform hover:scale-110 transition-transform duration-300 animate-text-shimmer hover:drop-shadow-[0_10px_10px_rgba(0,0,0,0.8)] transition-all" style={{ animationDelay: '0.5s' }}>S.</span>
              <span className="inline-block transform hover:scale-110 transition-transform duration-300 animate-text-shimmer ml-2 hover:drop-shadow-[0_10px_10px_rgba(0,0,0,0.8)] transition-all" style={{ animationDelay: '1s' }}>D.</span>
              <span className="inline-block transform hover:scale-110 transition-transform duration-300 animate-text-shimmer ml-2 hover:drop-shadow-[0_10px_10px_rgba(0,0,0,0.8)] transition-all" style={{ animationDelay: '1.5s' }}>Academy</span>
            </h1>
          </div>
          ...
          <div className={`transform transition-all duration-1000 preserve-3d ${showSubtitle ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
            <p className="text-2xl md:text-3xl text-white mb-8 animate-float hover:drop-shadow-[0_8px_8px_rgba(0,0,0,0.7)] transition-all duration-300">
          ...
          <div className={`transform transition-all duration-1000 ${showButton ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
            ...
            >
              <span className="relative z-10 font-medium text-lg transition-all duration-300 group-hover:font-extrabold group-hover:tracking-wide active:font-extrabold active:tracking-wide hover:drop-shadow-[0_4px_4px_rgba(0,0,0,0.6)]">Discover More</span>
