...
export default function DanceAndMusic() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-24 pb-12">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-3xl font-bold text-sdblue">Dance & Music</h1>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h2 className="text-xl font-semibold text-sdblue">Programs Offered:</h2>
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                <li>Classical dance training</li>
                <li>Modern dance forms</li>
                <li>Vocal music classes</li>
                <li>Instrumental music training</li>
          ...
          <div className="relative rounded-lg overflow-hidden shadow-xl transform hover:scale-105 transition-transform duration-300">
            <img 
              ...
              alt="Dance and Music Activities"
